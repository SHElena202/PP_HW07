...
urlpatterns = [
    ...
    path('searchresult/<int:pk>', GetSearchQuestion.as_view({'get': 'list'}), name='searchresult'),
    path('getanswers/<int:pk>', GetAnswers.as_view({'get': 'list'}), name='getanswers'),
    path('openapi/', get_schema_view(title="Hasker", descrption="API"), name='openapi-schema'),
]